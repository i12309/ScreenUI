...
bool screen32_bind_generated_ui_map(screenlib::adapter::UiObjectMap& objectMap,
    ...
    allOk = bind_page(objectMap, 8u, objects.wait) && allOk;
    allOk = bind_page(objectMap, 9u, objects.keyboard) && allOk;
    allOk = bind_page(objectMap, 10u, objects.service) && allOk;
    allOk = bind_page(objectMap, 11u, objects.service2) && allOk;
    allOk = bind_page(objectMap, 12u, objects.def_page) && allOk;
    ...
    allOk = bind_element(objectMap, 586431142u, 8u, objects.wait_text1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 771098777u, 8u, objects.wait_text2, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 707471411u, 8u, objects.wait_text3, outElements, outCapacity, boundCount) && allOk;
    ...
    allOk = bind_element(objectMap, 598393631u, 12u, objects.c_page_9, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 749654442u, 12u, objects.c_bar_10, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 705408621u, 12u, objects.title_6, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1032392636u, 12u, objects.sig_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 588353075u, 12u, objects.b_sig1_6, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 956711336u, 12u, objects.b_sig1_7, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 563615222u, 12u, objects.b_sig1_8, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 963860651u, 12u, objects.next_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 876012449u, 12u, objects.c_button_9, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 740047140u, 12u, objects.b1_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1013691630u, 12u, objects.b2_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1053036969u, 12u, objects.b3_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 675347161u, 12u, objects.b4_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 754207632u, 12u, objects.b5_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 872159707u, 12u, objects.b6_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 948484049u, 13u, objects.c_page_5, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 944737715u, 13u, objects.c_bar_6, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1008508692u, 13u, objects.back_5, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1068966703u, 13u, objects.title_5, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1015375349u, 13u, objects.next_13, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 834401655u, 13u, objects.next_14, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1034510309u, 13u, objects.next_15, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 916975904u, 13u, objects.c_button_5, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 684417468u, 14u, objects.c_page_2, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 546217965u, 14u, objects.c_bar_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 839392768u, 14u, objects.back_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 684863696u, 14u, objects.title_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 624416224u, 14u, objects.next_7, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 921401456u, 14u, objects.next_8, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 544800465u, 14u, objects.next_9, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 537248280u, 14u, objects.c_button_2, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 916570524u, 15u, objects.c_page_3, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 800731870u, 15u, objects.c_bar_4, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 931023985u, 15u, objects.back_4, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 585286522u, 15u, objects.title_4, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 920710893u, 15u, objects.next_10, outElements, outCapacity, boundCount) && allOk;
