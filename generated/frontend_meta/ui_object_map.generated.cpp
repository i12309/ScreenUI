...
bool screen32_bind_generated_ui_map(screenlib::adapter::UiObjectMap& objectMap,
    ...
    allOk = bind_page(objectMap, 10u, objects.keyboard) && allOk;
    allOk = bind_page(objectMap, 11u, objects.service) && allOk;
    allOk = bind_page(objectMap, 12u, objects.service2) && allOk;
    ...
    allOk = bind_element(objectMap, 809266216u, 11u, objects.c_page, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 984274153u, 11u, objects.c_bar, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 705822426u, 11u, objects.service_back, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 783057328u, 11u, objects.service_title, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1035025291u, 11u, objects.next_2, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1013391020u, 11u, objects.c_button, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 876544731u, 11u, objects.service_table, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 649580207u, 11u, objects.service_paper, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 1005812956u, 11u, objects.service_guillotine, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 955000198u, 11u, objects.service_slice, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 660622916u, 11u, objects.service_calibration, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 560154889u, 11u, objects.service_proba, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 654593177u, 12u, objects.c_page_10, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 564830685u, 12u, objects.c_bar_11, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 638419350u, 12u, objects.service2_back, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 579003233u, 12u, objects.service2_title, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 633576603u, 12u, objects.c_button_10, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 748959496u, 12u, objects.service_table_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 620561065u, 12u, objects.service_paper_1, outElements, outCapacity, boundCount) && allOk;
    allOk = bind_element(objectMap, 937444719u, 12u, objects.service_guillotine_1, outElements, outCapacity, boundCount) && allOk;
