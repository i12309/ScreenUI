...
static const Screen32ElementDescriptor g_screen32_element_descriptors[SCREEN32_ELEMENT_DESCRIPTOR_COUNT] = {
    ...
    {1037398668u, "drp_INIT_MACHINE", "init_machine", 7u, "INIT", TYPE_DROPDOWN, true, true, true, true, false, true},
    {858911524u, "btn_INIT_GROUP", "init_group", 7u, "INIT", TYPE_BUTTON, true, false, true, true, true, false},
    {757239833u, "btn_INIT_NAME", "init_name", 7u, "INIT", TYPE_BUTTON, true, false, true, true, true, false},
    {1015158681u, "btn_INIT_ACCESS_POINT", "init_access_point", 7u, "INIT", TYPE_BUTTON, true, false, true, true, true, false},
    {1070125018u, "chk_INIT_R_ACCESS_POINT", "init_r_access_point", 7u, "INIT", TYPE_CHECKBOX, true, true, true, true, false, true},
    {1068134903u, "btn_INIT_TEST", "init_test", 7u, "INIT", TYPE_BUTTON, true, false, true, true, true, false},
    {611967224u, "chk_INIT_R_TEST", "init_r_test", 7u, "INIT", TYPE_CHECKBOX, true, true, true, true, false, true},
    {586431142u, "btn_WAIT_TEXT1", "wait_text1", 8u, "WAIT", TYPE_BUTTON, true, false, true, true, true, false},
    {771098777u, "btn_WAIT_TEXT2", "wait_text2", 8u, "WAIT", TYPE_BUTTON, true, false, true, true, true, false},
    {707471411u, "btn_WAIT_TEXT3", "wait_text3", 8u, "WAIT", TYPE_BUTTON, true, false, true, true, true, false},
