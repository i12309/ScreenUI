...
static const Screen32ElementDescriptor g_screen32_element_descriptors[SCREEN32_ELEMENT_DESCRIPTOR_COUNT] = {
    ...
    {809266216u, "cnt_PAGE", "c_page", 11u, "SERVICE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {984274153u, "cnt_BAR", "c_bar", 11u, "SERVICE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {705822426u, "btn_SERVICE_BACK", "service_back", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {783057328u, "pnl_SERVICE_TITLE", "service_title", 11u, "SERVICE", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {1035025291u, "btn_NEXT_2", "next_2", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1013391020u, "cnt_BUTTON", "c_button", 11u, "SERVICE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {876544731u, "btn_SERVICE_TABLE", "service_table", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {649580207u, "btn_SERVICE_PAPER", "service_paper", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1005812956u, "btn_SERVICE_GUILLOTINE", "service_guillotine", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {955000198u, "btn_SERVICE_SLICE", "service_slice", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {660622916u, "btn_SERVICE_CALIBRATION", "service_calibration", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {560154889u, "btn_SERVICE_PROBA", "service_proba", 11u, "SERVICE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {654593177u, "cnt_PAGE_10", "c_page_10", 12u, "SERVICE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {564830685u, "cnt_BAR_11", "c_bar_11", 12u, "SERVICE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {638419350u, "btn_SERVICE2_BACK", "service2_back", 12u, "SERVICE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {579003233u, "pnl_SERVICE2_TITLE", "service2_title", 12u, "SERVICE2", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {633576603u, "cnt_BUTTON_10", "c_button_10", 12u, "SERVICE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {748959496u, "btn_SERVICE_TABLE_1", "service_table_1", 12u, "SERVICE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {620561065u, "btn_SERVICE_PAPER_1", "service_paper_1", 12u, "SERVICE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {937444719u, "btn_SERVICE_GUILLOTINE_1", "service_guillotine_1", 12u, "SERVICE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {598393631u, "cnt_PAGE_9", "c_page_9", 13u, "DEF_PAGE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {749654442u, "cnt_BAR_10", "c_bar_10", 13u, "DEF_PAGE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {705408621u, "pnl_TITLE_6", "title_6", 13u, "DEF_PAGE", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {1032392636u, "pnl_SIG_3", "sig_3", 13u, "DEF_PAGE", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {588353075u, "btn_SIG1_6", "b_sig1_6", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {956711336u, "btn_SIG1_7", "b_sig1_7", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {563615222u, "btn_SIG1_8", "b_sig1_8", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {963860651u, "btn_NEXT_3", "next_3", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {876012449u, "cnt_BUTTON_9", "c_button_9", 13u, "DEF_PAGE", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {740047140u, "btn_B1_1", "b1_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1013691630u, "btn_B2_1", "b2_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1053036969u, "btn_B3_1", "b3_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {675347161u, "btn_B4_1", "b4_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {754207632u, "btn_B5_1", "b5_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {872159707u, "btn_B6_1", "b6_1", 13u, "DEF_PAGE", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {948484049u, "cnt_PAGE_5", "c_page_5", 14u, "DEF_PAGE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {944737715u, "cnt_BAR_6", "c_bar_6", 14u, "DEF_PAGE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {1008508692u, "btn_BACK_5", "back_5", 14u, "DEF_PAGE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1068966703u, "pnl_TITLE_5", "title_5", 14u, "DEF_PAGE2", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {1015375349u, "btn_NEXT_13", "next_13", 14u, "DEF_PAGE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {834401655u, "btn_NEXT_14", "next_14", 14u, "DEF_PAGE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1034510309u, "btn_NEXT_15", "next_15", 14u, "DEF_PAGE2", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {916975904u, "cnt_BUTTON_5", "c_button_5", 14u, "DEF_PAGE2", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {684417468u, "cnt_PAGE_2", "c_page_2", 15u, "DEF_PAGE3", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {546217965u, "cnt_BAR_3", "c_bar_3", 15u, "DEF_PAGE3", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {839392768u, "btn_BACK_3", "back_3", 15u, "DEF_PAGE3", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {684863696u, "pnl_TITLE_3", "title_3", 15u, "DEF_PAGE3", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {624416224u, "btn_NEXT_7", "next_7", 15u, "DEF_PAGE3", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {921401456u, "btn_NEXT_8", "next_8", 15u, "DEF_PAGE3", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {544800465u, "btn_NEXT_9", "next_9", 15u, "DEF_PAGE3", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {537248280u, "cnt_BUTTON_2", "c_button_2", 15u, "DEF_PAGE3", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {916570524u, "cnt_PAGE_3", "c_page_3", 16u, "DEF_PAGE4", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {800731870u, "cnt_BAR_4", "c_bar_4", 16u, "DEF_PAGE4", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
    {931023985u, "btn_BACK_4", "back_4", 16u, "DEF_PAGE4", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {585286522u, "pnl_TITLE_4", "title_4", 16u, "DEF_PAGE4", TYPE_PANEL, true, false, true, true, false, false, 0x190Eu},
    {920710893u, "btn_NEXT_10", "next_10", 16u, "DEF_PAGE4", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {1033400519u, "btn_NEXT_11", "next_11", 16u, "DEF_PAGE4", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {600400769u, "btn_NEXT_12", "next_12", 16u, "DEF_PAGE4", TYPE_BUTTON, true, false, true, true, true, false, 0x034Eu},
    {937141394u, "cnt_BUTTON_3", "c_button_3", 16u, "DEF_PAGE4", TYPE_CONTAINER, true, false, true, true, false, false, 0x190Eu},
};
